...
var o_o = {                                       
  each: function(collection, callback) {
    for(var i = 0; i < collection.length; i++){  // iterate through collection
      callback(collection[i]);                   // call callback on each item in collection
    }
    /*
  ...
  map: function(collection, callback){
    var newOutput = [];                             // init empty array
    for(var i = 0; i < collection.length; i++){     // iterate through collection
      newOutput.push(callback(collection[i]));      // push each item into the array
    }
    return newOutput;                               // return filled array
  ...
  filter: function(collection, callback) {
    var newOutput = [];                             // init empty array
    for(var i = 0; i < collection.length; i++){     // iterate through collection
      if(callback(collection[i])){                  // if result of callback is true
          newOutput.push(collection[i]);            // push item into array
      }

    }
    return newOutput;                               // return new array
    /*
